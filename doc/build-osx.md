...
1. Clone the Khrysus Core source code:

        git clone https://github.com/khrysus-project/khrysus
        cd khrysus
...
Khrysus Core is now available at `./src/khrysusd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/Khrysus"

    touch "/Users/${USER}/Library/Application Support/Khrysus/khrysus.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Khrysus/khrysus.conf"

The first time you run khrysusd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/khrysusd -daemon # Starts the khrysus daemon.
    ./src/khrysus-cli --help # Outputs a list of command-line options.
    ./src/khrysus-cli help # Outputs a list of RPC commands when the daemon is running.
