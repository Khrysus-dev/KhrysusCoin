...
* Update translations see [translation_process.md](https://github.com/khrysus/khrysus/blob/master/doc/translation_process.md#synchronising-translations).
...
### Khrysus maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Khrysus Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit khrysus=v${VERSION} ../khrysus/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit khrysus=v${VERSION} ../khrysus/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit khrysus=v${VERSION} ../khrysus/contrib/gitian-descriptors/gitian-osx.yml
    ...
    ./bin/gbuild --memory 3000 --commit khrysus=v${VERSION} ../khrysus/contrib/gitian-descriptors/gitian-aarch64.yml
    ./bin/gsign --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../khrysus/contrib/gitian-descriptors/gitian-aarch64.yml
    mv build/out/khrysus-*.tar.gz build/out/src/khrysus-*.tar.gz ../
    popd
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`khrysus-${VERSION}-osx-unsigned.dmg`, `khrysus-${VERSION}-osx64.tar.gz`)
...
Codesigner only: Sign the osx binary:
    ...
    transfer khrysus-osx-unsigned.tar.gz to osx for signing
...
- Detached signatures will then be committed to the [khrysus-detached-sigs](https://github.com/khrysus/khrysus-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the https://www.khry.network/ server*.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/khrysus/khrysus/releases/new) with a link to the archived release notes.
