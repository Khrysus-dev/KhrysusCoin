...
```bash
    ...
    From https://github.com/khrysus/khrysus
...
For example:
```bash
URL=https://github.com/konez2k/khrysus.git
...
[khrysus/gitian.sigs](https://github.com/khrysus/gitian.sigs/) repository, or if that's not possible to create a pull
request.
