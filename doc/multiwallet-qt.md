...
In order to support loading of multiple wallets in khrysus-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is khrysus.cpp.
...
Changes to khrysus.cpp
----------------------
khrysus.cpp is the entry point into khrysus-qt, and as such, will require some minor modifications to provide hooks for
