...
from fake_stake.base_test import Khrysus_FakeStakeTest

class zKHRSValidCoinSpendTest(Khrysus_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zKHRSs..." % DENOM_TO_USE)
