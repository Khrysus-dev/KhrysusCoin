Contributing to Khrysus Core
============================

The Khrysus Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/khrysus-project/khrysus/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Khrysus Core project, and is not to be
confused with overall Khrysus Network Protocol consensus changes.

Whether a pull request is merged into Khrysus Core rests with the project merge
...
Patches that change Khrysus consensus rules are considerably more involved than
...
Where a patchset proposes to change the Khrysus consensus, it must have been
...
The project leader is the release manager for each Khrysus Core release.
