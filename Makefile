...
pkgdatadir = $(datadir)/khrysus
pkgincludedir = $(includedir)/khrysus
pkglibdir = $(libdir)/khrysus
pkglibexecdir = $(libexecdir)/khrysus
...
CONFIG_HEADER = $(top_builddir)/src/config/khrysus-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/khrysus-config.h.in \
...
ACLOCAL = ${SHELL} /home/dad/Downloads/Wallet/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/dad/Downloads/Wallet/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/dad/Downloads/Wallet/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/dad/Downloads/Wallet/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = khrysus-cli
BITCOIN_DAEMON_NAME = khrysusd
BITCOIN_GUI_NAME = khrysus-qt
BITCOIN_TX_NAME = khrysus-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/dad/Downloads/Wallet/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = Khrysus Core
PACKAGE_STRING = Khrysus Core 1.0.0
PACKAGE_TARNAME = khrysus
PACKAGE_URL = 
...
PYTHONPATH = /home/dad/Downloads/Wallet/depends/x86_64-pc-linux-gnu/share/../native/lib/python/dist-packages:
QR_CFLAGS = 
QR_LIBS = -lqrencode
QTPLATFORM_CFLAGS = 
QTPLATFORM_LIBS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/dad/Downloads/Wallet
abs_srcdir = /home/dad/Downloads/Wallet
abs_top_builddir = /home/dad/Downloads/Wallet
abs_top_srcdir = /home/dad/Downloads/Wallet
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/dad/Downloads/Wallet/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_khrysus_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_khrysus_coverage.info test_khrysus.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Khrysus-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/khrysus-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/khrysus-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/khrysus-config.h
$(top_srcdir)/src/config/khrysus-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/khrysus-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Khrysus-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Khrysus-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Khrysus-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_khrysus.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_khrysus -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_khrysus_filtered.info: test_khrysus.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_khrysus_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_khrysus_coverage.info: baseline_filtered_combined.info test_khrysus_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_khrysus_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_khrysus_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_khrysus_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_khrysus.coverage/.dirstamp:  test_khrysus_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_khrysus.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_khrysus.coverage/ total.coverage/ $(OSX_APP)
