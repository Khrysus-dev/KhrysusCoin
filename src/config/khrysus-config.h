/* src/config/khrysus-config.h.  Generated from khrysus-config.h.in by configure.  */
/* src/config/khrysus-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KHRY_CONFIG_H

#define KHRY_CONFIG_H
...
#define PACKAGE_NAME "Khrysus Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Khrysus Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "khrysus"
