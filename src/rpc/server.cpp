...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Khrysus server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Khrysus features */
        {"khrysus", "listmasternodes", &listmasternodes, true, true, false},
        {"khrysus", "getmasternodecount", &getmasternodecount, true, true, false},
        {"khrysus", "masternodeconnect", &masternodeconnect, true, true, false},
        {"khrysus", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"khrysus", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"khrysus", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"khrysus", "masternodecurrent", &masternodecurrent, true, true, false},
        {"khrysus", "masternodedebug", &masternodedebug, true, true, false},
        {"khrysus", "startmasternode", &startmasternode, true, true, false},
        {"khrysus", "createmasternodekey", &createmasternodekey, true, true, false},
        {"khrysus", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"khrysus", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"khrysus", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"khrysus", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"khrysus", "getmasternodescores", &getmasternodescores, true, true, false},
        {"khrysus", "preparebudget", &preparebudget, true, true, false},
        {"khrysus", "submitbudget", &submitbudget, true, true, false},
        {"khrysus", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"khrysus", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"khrysus", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"khrysus", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"khrysus", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"khrysus", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"khrysus", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"khrysus", "checkbudgets", &checkbudgets, true, true, false},
        {"khrysus", "mnsync", &mnsync, true, true, false},
        {"khrysus", "spork", &spork, true, true, false},
        {"khrysus", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzkhrsseed", &getzkhrsseed, false, false, true},
        {"zerocoin", "setzkhrsseed", &setzkhrsseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzkhrs", &searchdzkhrs, false, false, true},
        {"zerocoin", "dzkhrsstate", &dzkhrsstate, false, false, true},
...
{
    return "> khrysus-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21325/\n";
}
