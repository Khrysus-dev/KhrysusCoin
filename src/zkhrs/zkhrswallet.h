...
#ifndef Khrysus_ZKHRSWALLET_H
#define Khrysus_ZKHRSWALLET_H
...
public:
    CzKHRSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZKHRS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZKHRS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
