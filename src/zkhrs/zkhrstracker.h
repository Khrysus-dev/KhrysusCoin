...
#ifndef Khrysus_ZKHRSTRACKER_H
#define Khrysus_ZKHRSTRACKER_H
...
public:
    CzKHRSTracker(std::string strWalletFile);
    ~CzKHRSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzKHRSWallet* zKHRSWallet = NULL);
