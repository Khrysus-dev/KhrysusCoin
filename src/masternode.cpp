...
MASTERNODE_COLLATERAL;
  ...
  MASTERNODE_COLLATERALA;
  } else if (nHeight <= 50001) {
  MASTERNODE_COLLATERALB;
  } else if (nHeight <= 65001) {
  MASTERNODE_COLLATERALC;
  } else if (nHeight <= 110001) {
  MASTERNODE_COLLATERALD;
  } else if (nHeight <= 125001) {
  MASTERNODE_COLLATERALE;
  } else if (nHeight <= 170001) {
  MASTERNODE_COLLATERALF;
  } else if (nHeight <= 185001) {
  MASTERNODE_COLLATERALG;
  } else if (nHeight <= 280001) {
  MASTERNODE_COLLATERALH;
  } else if (nHeight <= 310001) {
  MASTERNODE_COLLATERALI;
  } else if (nHeight <= 420001) {
  MASTERNODE_COLLATERALJ;
  } else if (nHeight <= 450001) {
  MASTERNODE_COLLATERALK;
  } else if (nHeight <= 600001) {
  MASTERNODE_COLLATERALL;
  } else if (nHeight <= 640001) {
  MASTERNODE_COLLATERALM;
  } else if (nHeight <= 800001) {
  MASTERNODE_COLLATERALN;
  } else if (nHeight <= 850001) {
  MASTERNODE_COLLATERALO;
  } else if (nHeight <= 1050001) {
  MASTERNODE_COLLATERALP;
  } else if (nHeight <= 1100001) {
  MASTERNODE_COLLATERALQ;
} else if (nHeight <= 1400001) {
  MASTERNODE_COLLATERALR;
  } else
...
bool CMasternodeBroadcast::CheckAndUpdate(int& nDos)
{
    ...
    // if (Params().NetworkID() == CBaseChainParams::MAIN) {
    //     if (addr.GetPort() != 21326) return false;
    // } else if (addr.GetPort() == 21326)
    //     return false;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 KHRY tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = 0;
    CTransaction tx2;
