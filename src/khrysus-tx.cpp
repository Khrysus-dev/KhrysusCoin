...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Khrysus Core khrysus-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  khrysus-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded khrysus transaction") + "\n" +
                               "  khrysus-tx [options] -create [commands]   " + _("Create hex-encoded khrysus transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded khrysus transaction
