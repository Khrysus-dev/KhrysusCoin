                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzKHRSPathCustom = GetArg("-zkhrsbackuppath", "");
    ...
    if(!strzKHRSPathCustom.empty()) {
        ui->wallet_customzkhrsbackuppath->setText(QString::fromStdString(strzKHRSPathCustom));
        ui->wallet_customzkhrsbackuppath_label->setVisible(true);
        ui->wallet_customzkhrsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzKHRSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Khrysus RPC console.") + "<br>" +
