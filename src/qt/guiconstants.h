...
/* Khrysus GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Khrysus"
#define QAPP_ORG_DOMAIN "khrysus.org"
#define QAPP_APP_NAME_DEFAULT "Khrysus-Qt"
#define QAPP_APP_NAME_TESTNET "Khrysus-Qt-testnet"
