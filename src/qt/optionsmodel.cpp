...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::KHRS);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeKhrysusAmount"))
        SoftSetArg("-anonymizekhrysusamount", settings.value("nAnonymizeKhrysusAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in khrysus.cpp during shotdown to also remove the window positions
