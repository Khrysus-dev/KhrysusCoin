...
/** Utility functions used by the Khrysus Qt UI.
 */
namespace GUIUtil
{
...
// Render Khrysus addresses in monospace font
...
// Parse "khrysus:" URI into recipient object, return true on successful parsing
