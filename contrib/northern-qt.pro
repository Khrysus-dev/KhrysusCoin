...
RESOURCES += src/qt/khrysus.qrc src/qt/khrysus_locale.qrc

TRANSLATIONS += src/qt/locale/khrysus_bg.ts \
                src/qt/locale/khrysus_de.ts \
                src/qt/locale/khrysus_en.ts \
                src/qt/locale/khrysus_es.ts \
                src/qt/locale/khrysus_fi.ts \
                src/qt/locale/khrysus_fr.ts \
                src/qt/locale/khrysus_it.ts \
                src/qt/locale/khrysus_ja.ts \
                src/qt/locale/khrysus_pl.ts \
                src/qt/locale/khrysus_pt.ts \
                src/qt/locale/khrysus_ru.ts \
                src/qt/locale/khrysus_sk.ts \
                src/qt/locale/khrysus_sv.ts \
                src/qt/locale/khrysus_vi.ts \
                src/qt/locale/khrysus_zh_CN.ts \
                src/qt/locale/khrysus_zh_TW.ts
