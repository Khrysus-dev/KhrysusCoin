...
#   c) node1 mines 32 blocks, so now node 0 has 500000KHRY, node 1 has 4250KHRY, node2 has none.
#   d) node0 sends 601 KHRY to node2, in two transactions (301 KHRY, then 300 KHRY).
